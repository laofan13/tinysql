 ...
 */
func onDropColumn(t *meta.Meta, job *model.Job) (ver int64, err error) {
	...
	case model.StatePublic:
		...
		odValue, err := generateOriginDefaultValue(colInfo)
		if err != nil {
			return ver, errors.Trace(err)
		}
		colInfo.DefaultValue = odValue
